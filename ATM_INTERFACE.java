...
public class ATM_INTERFACE {
    ...
    private static void printMenu() {
        ...
        System.out.println("\u001B[33m**      \u001B[32mWelcome to ATM\u001B[33m      **\u001B[0m"); // Green color for
                                                                                                     // header
...
class BankAccount {
    ...
    // Returns true if withdrawal is successful, false if there are insufficient
    // funds
    ...
    public void processOption(int option) {
        ...
        switch (option) {
            case 1:
                ...
                System.out.println("\u001B[32mYour balance: ₹" + account.getBalance() + "\u001B[0m"); // Green color for
                                                                                                      // balance
                break;
            case 2:
                // Withdraw money
                System.out.print("\u001B[36mEnter the  amount to withdraw: ₹\u001B[0m"); // Cyan color for input text
                amount = scanner.nextDouble();
                if (account.withdraw(amount)) {
                    // Withdrawal successful
                    System.out.println("\u001B[32mWithdrawal successful. Remaining balance: ₹" + account.getBalance()
                            + "\u001B[0m"); // Green color for success message
                } else {
                    // Insufficient funds for withdrawal
                    System.out.println("\u001B[31mInsufficient funds. Withdrawal failed.\u001B[0m"); // Red color for
                                                                                                     // error message
                }
                break;
            case 3:
                // Deposit money
                System.out.print("\u001B[36mEnter the amount to deposit: ₹\u001B[0m"); // Cyan color for input text
                amount = scanner.nextDouble();
                account.deposit(amount);
                // Deposit successful
                System.out.println(
                        "\u001B[32mDeposited successfully. Updated balance: ₹" + account.getBalance() + "\u001B[0m"); // Green
                // color
                // for
                // success
                // message
            ...
            case 4:
                ...
                System.out.println("\u001B[32mThank you for using the ATM. Have a Nice day!\u001B[0m"); // Green color
                                                                                                        // for exit
                // message
                System.exit(0);
                break;
            default:
                // Invalid option
                System.out.println("\u001B[31mInvalid option. Please try again.\u001B[0m"); // Red color for error
                                                                                            // message
        }
    }
}
