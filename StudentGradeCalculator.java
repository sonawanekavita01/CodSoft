...
//                number of subjects and the marks obtained in each subject from the user. 
//                   The program validates the input and provides results including the total marks, average
...
public class StudentGradeCalculator {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Input: Enter the marks obtained in each subject
